...
Click [here](https://dakixr.github.io/scc/example/index.html) to see an interactive example of SCC portal generated by using oeg-upm organization as input as shown bellow:
