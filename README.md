...
Click [here](https://dakixr.github.io/scc/example/index.html) to see an interactive example of a SCC portal generated by using oeg-upm organization as input for SCC.  
...
In case you want to change the default style of the portal, SCC decouples the .css files from the code-base. So in the resulting portal directory two .css files are available for further tinkering and styling the portal to everyone needs.
